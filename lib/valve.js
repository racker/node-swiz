 ...
 * valid-looking URL.
 *
 * The validator library supports the following options:
 *   * protocols - default: ['http', 'https', 'ftp']
 *   * require_tld - default: true
 *   * require_protocol - default: false
 *
 * @return {Chain} The validator chain to which the validator was added.
 */
Chain.prototype.isUrl = function(options) {
  options = options || {};
  this._pushValidator({
    name: 'isUrl',
    func: function(value, baton, callback) {
      if (!check.isURL(value, options)) {
